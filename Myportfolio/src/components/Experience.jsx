...
const experiences = [
  {
    ...
    desc: [
      "Completed 200+ hours of hands-on training in Core Java, OOP, DSA and SQL.",
      "Built 2+ full-stack applications using Java, Spring Boot, REST APIs, MySQL, and Oracle SQL.",
      "Developed and tested 15+ RESTful APIs with optimized performance.",
      "Solved 150+ DSA problems, strengthening problem-solving and coding skills.",
    ],
